...
typedef PwhashStorageNative = Int8 Function(Pointer<Uint8> out,
    Pointer<Uint8> passwd, Uint64 passwdLen, Uint64 opsLimit, IntPtr memlimit);
typedef PwhashStorageDart = int Function(Pointer<Uint8> out,
    Pointer<Uint8> passwd, int passwdLen, int opsLimit, int memlimit);

typedef PwhashStorageVerifyNative = Int8 Function(
    Pointer<Uint8> str, Pointer<Uint8> passwd, IntPtr passwdlen);
typedef PwhashStorageVerifyDart = int Function(
    Pointer<Uint8> str, Pointer<Uint8> passwd, int passwdlen);

typedef PwhashNeedsRehashNative = Int8 Function(
    Pointer<Uint8> str, Uint64 opsLimit, IntPtr memLimit);
...
class PasswordHash {
  PasswordHash(DynamicLibrary sodium)
      : opslimit = OpsLimit(sodium),
        ...
        storage = sodium
            .lookup<NativeFunction<PwhashStorageNative>>('crypto_pwhash_str')
            .asFunction(),
        verify = sodium
            .lookup<NativeFunction<PwhashStorageVerifyNative>>(
                'crypto_pwhash_str_verify')
            .asFunction(),
        needsRehash = sodium
            .lookup<NativeFunction<PwhashNeedsRehashNative>>(
