...
/// The [nonce] needs to be stored alongside the ciphertext for decryption and doesn't need to be secret.
...
/// Used to decrypt ciphertexts generated by [secretBoxEasy]
