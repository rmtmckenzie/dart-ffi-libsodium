...
abstract class SecretBox {
  ...
  /// Generates a random key with the correct length of [secretBoxKeyBytes].
  ...
  static Uint8List easy(Uint8List msg, Uint8List nonce, Uint8List key) {
    ...
    assert(key.length != SecretBox.keyBytes,
  ...
  /// Decrypts ciphertexts generated by [secretBoxEasy]
