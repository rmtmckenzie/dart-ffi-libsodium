...
/// When [throwWhenInvalid] is true, an [InvalidSignatureError] will be thrown
/// when the signature is not valid; otherwise null will be returned.
Uint8List open(Uint8List signedMessage, Uint8List publicKey,
    {bool throwWhenInvalid = true}) {
  ...
  final result = bindings.signOpen(signedMessagePtr.rawPtr, nullptr.cast(),
      messagePtr.rawPtr, signedMessage.length, pkPtr.rawPtr);
